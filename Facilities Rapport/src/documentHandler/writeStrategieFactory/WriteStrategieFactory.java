...
public class WriteStrategieFactory {
	 ...
	 * @param strategie int permettant de choisir la strategie souhaitee. Voir avec les constantes de cette classe
	...
	public static IWriteStrategie getStrategie (int strategie) throws Exception{
		switch (strategie) {
			...
			default:
				throw new Exception("Invalid strategie. Use final static attributes from StrategieFactory class to choose youre strategie.");
		}
